...
import "../app.css?v=280520231"; // CSS file that is generated by TailwindCSS, version number is for caching purposes (so that the browser knows to download the new CSS file)
