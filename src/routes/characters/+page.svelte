  ...
  <section class="py-24 md:py-40">
    <div class="container px-4 mx-auto">
      ...
      <p class="text-gray-400 text-sm">
        Contains all playable characters from 1.0 to the current live version,
        beta versions are not included.
      </p>

      <br />
      <h1 class="text-white font-semibold gifont">
        <span class="text-[#E2C96F]">5*</span> Characters
      </h1>
      ...
      <br />
      <h1 class="text-white font-semibold gifont">
        <span class="text-[#84719D]">4*</span> Characters
      </h1>
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
