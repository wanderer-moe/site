...
<section class="py-24 md:py-40">
	...
	<h1 class = "text-white font-semibold"><span class = "gifont">Splash Art</span><br><span class = "text-sm font-normal text-gray-400">You can download <a href = "https://codeload.github.com/dromzeh/genshin-splash-art/zip/refs/heads/main" class = "font-semibold text-white hover:text-indigo-400">all splash art (.zip) here</a>.</span></h1>
