...
// create a get request to https://api.github.com/repos/dromzeh/genshin-splash-art/git/trees/main?recursive=1
let tree = []

onMount(async () => {
  try {
    let response = await axios.get('https://api.github.com/repos/dromzeh/genshin-splash-art/git/trees/main?recursive=1')
